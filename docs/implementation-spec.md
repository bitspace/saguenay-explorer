...
1. Stream DEM tiles from Mapzen Terrarium (`elevation-tiles-prod`) at runtime.
2. Compute `z/x/y` tile coordinates from camera-relative world position.
3. Decode terrain in app using Terrarium formula:
   - `height_m = R * 256 + G + B / 256 - 32768`
4. Optional utility script for local snapshot tiles:
